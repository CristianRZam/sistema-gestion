...
<div class="content">
    ...
    <div class="item">Cliente: {{ $compra->customer->nombre ?? '--' }}</div>
    <div class="item">Dirección: {{ $compra->customer->direccion ?? '--' }}</div>
    <div class="item">Fecha: {{ $compra->fecha_compra->format('d/m/Y') }}</div>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="text-align: right; padding: 2px 0; width: 40%;">S/ {{ number_format($compra->total, 2) }}</td>
        </tr>
        </tbody>
    </table>
