        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Mantenedor')" class="grid">
                    ...
                    @endcan
                    @can('ver servicios')
                        <flux:navlist.item :href="route('tables')" :current="request()->routeIs('tables')" wire:navigate>
                            <i class="fa-solid fa-table mr-2"></i> {{ __('Mesa') }}
                        </flux:navlist.item>
                    @endcan
                    @can('ver clientes')
                ...
                <flux:navlist.group :heading="__('Operaciones')" class="grid">
                    ...
                    @can('ver reservas')
                        <flux:navlist.item :href="route('order-services')" :current="request()->routeIs('order-services*')" wire:navigate>
                            <i class="fa-regular fa-clipboard mr-4"></i> {{ __('Atención de servicios') }}
                        </flux:navlist.item>
                    @endcan
                </flux:navlist.group>
